...
public class TubeRenderer : MonoBehaviour
{
    ...
    */
    ...
    public void Create()
    {
        ...
        transform.localScale = new Vector3(100,20,100);// Vector3.one * 50;
        Instantiate(mainShip, new Vector3(GameObject.Find("0").transform.position.x * 100,(GameObject.Find("0").transform.position.y * 100)+100,GameObject.Find("0").transform.position.z * 100), GameObject.Find("0").transform.rotation);
